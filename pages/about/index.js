      ...
      <div className=" container mx-auto h-full flex flex-col items-center xl:flex-row  gap-x-6">
        <div className="flex-1 flex flex-col justify-center ">
          ...
          <p className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">
            10 years ago, ibegan feelancing as a developer. Since then i ve done
            remote workk for agencies coubsulated for startup and cloojjkdjskdjs
            sdkjsdn sdkcdssdk woi eiwen{" "}
          </p>
          {/*counter*/}
          <div className=" hidden md:flex md:max-w-xl xl:max-w-none mx-auto xl:mx-0 mb-8 ">
            <div className="flex flex-1 xl:gap-x-6">
              ...
              <div className="relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0 ">  
                  <div className="text-accent text-2xl xl:text-4xl font-extrabold mb-2 ">
                    <CountUp start={0} end={10} duration={5} />+
                  </div>
                  <div className="font-bold uppercase text-xs tracking-[1px]  leading-[1.4] max-w-[100px]">
                    years of experience
                  </div>
                </div>
        ...
        <div className="flex flex-col w-full xl:max-w-[48%] h-[480px] items-center">
          <div className="flex gap-x-4 xl:gap-x-8 xl:mx-0 mb-4 mt-4">
